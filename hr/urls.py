...
from hr.views import employee_views, lifecycle_views, hr_modules_views, finance_views, recruitment_views, chatbot_views


urlpatterns = [
    # ── Root ───────────────────────────────────────────────────────
    path('', attendanceviews.live_attendance, name='hrms_dashboard'),
    path('careers/', recruitment_views.careers, name='careers'),
    path('apply/', recruitment_views.careers, name='apply'),
    path('hr/recruitment/', recruitment_views.recruitment_dashboard, name='recruitment_dashboard'),
